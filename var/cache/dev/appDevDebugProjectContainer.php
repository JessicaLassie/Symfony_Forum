...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'doctrine.password' => 'getDoctrine_PasswordService',
            ...
            'security.user.provider.concrete.author_provider' => 'getSecurity_User_Provider_Concrete_AuthorProviderService',
        ...
        $this->privates = array(
            ...
            'security.user.provider.concrete.author_provider' => true,
     ...
     */
    protected function getApp_HelloService()
    {
        return $this->services['app.hello'] = new \AppBundle\Services\HelloService($this->get('security.token_storage'));
    }
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('XSHkfti2qM', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('t1n9FeTYNc', 0, 'UzNp52wOWflMQMiaVuiojY', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $d->addEventSubscriber(${($_ = isset($this->services['stof_doctrine_extensions.listener.loggable']) ? $this->services['stof_doctrine_extensions.listener.loggable'] : $this->getStofDoctrineExtensions_Listener_LoggableService()) && false ?: '_'});
        $d->addEventSubscriber($c);
        $d->addEventSubscriber(${($_ = isset($this->services['stof_doctrine_extensions.listener.uploadable']) ? $this->services['stof_doctrine_extensions.listener.uploadable'] : $this->getStofDoctrineExtensions_Listener_UploadableService()) && false ?: '_'});
        $d->addEventListener(array(0 => 'loadClassMetadata'), $this->get('doctrine.orm.default_listeners.attach_entity_listeners'));
        $d->addEventListener(array(0 => 'prePersist'), $this->get('doctrine.password'));

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'sf-forum', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $d, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b->addCustomStringFunction('md5', 'Oro\\ORM\\Query\\AST\\Functions\\SimpleFunction');
        $b->addCustomStringFunction('group_concat', 'Oro\\ORM\\Query\\AST\\Functions\\String\\GroupConcat');
        $b->addCustomStringFunction('concat_ws', 'Oro\\ORM\\Query\\AST\\Functions\\String\\ConcatWs');
        $b->addCustomStringFunction('cast', 'Oro\\ORM\\Query\\AST\\Functions\\Cast');
        $b->addCustomStringFunction('replace', 'Oro\\ORM\\Query\\AST\\Functions\\String\\Replace');
        $b->addCustomStringFunction('date_format', 'Oro\\ORM\\Query\\AST\\Functions\\String\\DateFormat');
        $b->addCustomNumericFunction('timestampdiff', 'Oro\\ORM\\Query\\AST\\Functions\\Numeric\\TimestampDiff');
        $b->addCustomNumericFunction('dayofyear', 'Oro\\ORM\\Query\\AST\\Functions\\SimpleFunction');
        $b->addCustomNumericFunction('dayofmonth', 'Oro\\ORM\\Query\\AST\\Functions\\SimpleFunction');
        $b->addCustomNumericFunction('dayofweek', 'Oro\\ORM\\Query\\AST\\Functions\\SimpleFunction');
        $b->addCustomNumericFunction('week', 'Oro\\ORM\\Query\\AST\\Functions\\SimpleFunction');
        $b->addCustomNumericFunction('day', 'Oro\\ORM\\Query\\AST\\Functions\\SimpleFunction');
        $b->addCustomNumericFunction('hour', 'Oro\\ORM\\Query\\AST\\Functions\\SimpleFunction');
        $b->addCustomNumericFunction('minute', 'Oro\\ORM\\Query\\AST\\Functions\\SimpleFunction');
        $b->addCustomNumericFunction('month', 'Oro\\ORM\\Query\\AST\\Functions\\SimpleFunction');
        $b->addCustomNumericFunction('quarter', 'Oro\\ORM\\Query\\AST\\Functions\\SimpleFunction');
        $b->addCustomNumericFunction('second', 'Oro\\ORM\\Query\\AST\\Functions\\SimpleFunction');
        $b->addCustomNumericFunction('year', 'Oro\\ORM\\Query\\AST\\Functions\\SimpleFunction');
        $b->addCustomNumericFunction('sign', 'Oro\\ORM\\Query\\AST\\Functions\\Numeric\\Sign');
        $b->addCustomNumericFunction('pow', 'Oro\\ORM\\Query\\AST\\Functions\\Numeric\\Pow');
        $b->addCustomNumericFunction('round', 'Oro\\ORM\\Query\\AST\\Functions\\Numeric\\Round');
        $b->addCustomDatetimeFunction('date', 'Oro\\ORM\\Query\\AST\\Functions\\SimpleFunction');
        $b->addCustomDatetimeFunction('time', 'Oro\\ORM\\Query\\AST\\Functions\\SimpleFunction');
        $b->addCustomDatetimeFunction('timestamp', 'Oro\\ORM\\Query\\AST\\Functions\\SimpleFunction');
        $b->addCustomDatetimeFunction('convert_tz', 'Oro\\ORM\\Query\\AST\\Functions\\DateTime\\ConvertTz');
    ...
    /**
     * Gets the 'doctrine.password' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\DoctrineListener\PasswordListener A AppBundle\DoctrineListener\PasswordListener instance
     */
    protected function getDoctrine_PasswordService()
    {
        return $this->services['doctrine.password'] = new \AppBundle\DoctrineListener\PasswordListener($this->get('security.password_encoder'));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_b2211cf4917b6e3c98936e9684b728ebe9bcf82971d39eb7336f6d0f3989cb94');
    ...
    {
        return $this->services['exercise_html_purifier.cache_warmer.serializer'] = new \Exercise\HTMLPurifierBundle\CacheWarmer\SerializerCacheWarmer(array(0 => (__DIR__.'/htmlpurifier')), $this->get('exercise_html_purifier.default'));
    }
    ...
    {
        return $this->services['property_accessor'] = new \Symfony\Component\PropertyAccess\PropertyAccessor(false, false, \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('wquGsdXbD4', NULL, 'UzNp52wOWflMQMiaVuiojY', $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Symfony\\Component\\Security\\Core\\User\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\PlaintextPasswordEncoder', 'arguments' => array(0 => false)), 'AppBundle\\Entity\\Author' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\BCryptPasswordEncoder', 'arguments' => array(0 => 13))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_AdminService()
    {
        ...
        $g = new \Symfony\Component\Security\Http\Firewall\LogoutListener($a, $e, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($e, 'homepage'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => 'admin_logout'));
        ...
        $h->setOptions(array('login_path' => 'admin_login_route', 'default_target_path' => '/admin', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false));
        ...
        $i->setOptions(array('login_path' => 'admin_login_route', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        return $this->services['security.firewall.map.context.admin'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => ${($_ = isset($this->services['security.channel_listener']) ? $this->services['security.channel_listener'] : $this->getSecurity_ChannelListenerService()) && false ?: '_'}, 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => ${($_ = isset($this->services['security.user.provider.concrete.admin_provider']) ? $this->services['security.user.provider.concrete.admin_provider'] : $this->getSecurity_User_Provider_Concrete_AdminProviderService()) && false ?: '_'}, 1 => ${($_ = isset($this->services['security.user.provider.concrete.author_provider']) ? $this->services['security.user.provider.concrete.author_provider'] : $this->getSecurity_User_Provider_Concrete_AuthorProviderService()) && false ?: '_'}), 'admin', $b, $c, $d), 2 => $g, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, ${($_ = isset($this->services['security.authentication.manager']) ? $this->services['security.authentication.manager'] : $this->getSecurity_Authentication_ManagerService()) && false ?: '_'}, ${($_ = isset($this->services['security.authentication.session_strategy']) ? $this->services['security.authentication.session_strategy'] : $this->getSecurity_Authentication_SessionStrategyService()) && false ?: '_'}, $e, 'admin', $h, $i, array('check_path' => 'admin_check_route', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $b, $c, NULL), 4 => ${($_ = isset($this->services['security.access_listener']) ? $this->services['security.access_listener'] : $this->getSecurity_AccessListenerService()) && false ?: '_'}), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $d, $e, 'admin', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $e, 'admin_login_route', false), NULL, NULL, $b, false), new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('admin', 'security.user_checker', 'security.request_matcher.764e993b07f86c50f945d9bc29906d594dfc5b599c6dd619ee7f826206d068a50daecf5e', true, false, 'security.user.provider.concrete.admin_provider', 'admin', 'security.authentication.form_entry_point.admin', NULL, NULL, array(0 => 'logout', 1 => 'form_login')));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_LoginAdminService()
    {
        ...
        return $this->services['security.firewall.map.context.login_admin'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => ${($_ = isset($this->services['security.channel_listener']) ? $this->services['security.channel_listener'] : $this->getSecurity_ChannelListenerService()) && false ?: '_'}, 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => ${($_ = isset($this->services['security.user.provider.concrete.admin_provider']) ? $this->services['security.user.provider.concrete.admin_provider'] : $this->getSecurity_User_Provider_Concrete_AdminProviderService()) && false ?: '_'}, 1 => ${($_ = isset($this->services['security.user.provider.concrete.author_provider']) ? $this->services['security.user.provider.concrete.author_provider'] : $this->getSecurity_User_Provider_Concrete_AuthorProviderService()) && false ?: '_'}), 'login_admin', $b, $this->get('debug.event_dispatcher', ContainerInterface::NULL_ON_INVALID_REFERENCE), $c), 2 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '5a96cde1d4bdc5.20844117', $b, ${($_ = isset($this->services['security.authentication.manager']) ? $this->services['security.authentication.manager'] : $this->getSecurity_Authentication_ManagerService()) && false ?: '_'}), 3 => ${($_ = isset($this->services['security.access_listener']) ? $this->services['security.access_listener'] : $this->getSecurity_AccessListenerService()) && false ?: '_'}), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $c, ${($_ = isset($this->services['security.http_utils']) ? $this->services['security.http_utils'] : $this->getSecurity_HttpUtilsService()) && false ?: '_'}, 'login_admin', NULL, NULL, NULL, $b, false), new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('login_admin', 'security.user_checker', 'security.request_matcher.385147ffd543d432fa88e97f9fb0641681eeceafe0af89d7047be9324b8d64d2d31d53e0', true, false, 'security.user.provider.concrete.admin_provider', 'login_admin', NULL, NULL, NULL, array(0 => 'anonymous')));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $h = new \Symfony\Component\Security\Http\Firewall\LogoutListener($a, $e, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($e, 'homepage'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => 'author_logout'));
        ...
        $i->setOptions(array('login_path' => 'author_login_route', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        ...
        $j->setOptions(array('login_path' => 'author_login_route', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => ${($_ = isset($this->services['security.channel_listener']) ? $this->services['security.channel_listener'] : $this->getSecurity_ChannelListenerService()) && false ?: '_'}, 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => ${($_ = isset($this->services['security.user.provider.concrete.admin_provider']) ? $this->services['security.user.provider.concrete.admin_provider'] : $this->getSecurity_User_Provider_Concrete_AdminProviderService()) && false ?: '_'}, 1 => ${($_ = isset($this->services['security.user.provider.concrete.author_provider']) ? $this->services['security.user.provider.concrete.author_provider'] : $this->getSecurity_User_Provider_Concrete_AuthorProviderService()) && false ?: '_'}), 'main', $b, $c, $d), 2 => $h, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $g, ${($_ = isset($this->services['security.authentication.session_strategy']) ? $this->services['security.authentication.session_strategy'] : $this->getSecurity_Authentication_SessionStrategyService()) && false ?: '_'}, $e, 'main', $i, $j, array('check_path' => 'author_check_route', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $b, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '5a96cde1d4bdc5.20844117', $b, $g), 5 => ${($_ = isset($this->services['security.access_listener']) ? $this->services['security.access_listener'] : $this->getSecurity_AccessListenerService()) && false ?: '_'}), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $d, $e, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $e, 'author_login_route', false), NULL, NULL, $b, false), new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('main', 'security.user_checker', 'security.request_matcher.a64d671f18e5575531d76c1d1154fdc4476cb8a79c02ed7a3469178c6d7b96b5ed4e60db', true, false, 'security.user.provider.concrete.author_provider', 'main', 'security.authentication.form_entry_point.main', NULL, NULL, array(0 => 'logout', 1 => 'form_login', 2 => 'anonymous')));
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('nttNzraxbH', 0, 'UzNp52wOWflMQMiaVuiojY', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        ...
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5a96cde1d4bdc5.20844117'), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider(${($_ = isset($this->services['security.user.provider.concrete.admin_provider']) ? $this->services['security.user.provider.concrete.admin_provider'] : $this->getSecurity_User_Provider_Concrete_AdminProviderService()) && false ?: '_'}, $b, 'admin', $a, true), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider(${($_ = isset($this->services['security.user.provider.concrete.author_provider']) ? $this->services['security.user.provider.concrete.author_provider'] : $this->getSecurity_User_Provider_Concrete_AuthorProviderService()) && false ?: '_'}, $b, 'main', $a, true), 3 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5a96cde1d4bdc5.20844117')), true);
    ...
    {
        return $this->services['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/'), 'security.firewall.map.context.login_admin' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin-login$'), 'security.firewall.map.context.admin' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin'), 'security.firewall.map.context.main' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/')));
    }
    ...
    protected function getSecurity_LogoutUrlGeneratorService()
    {
        ...
        $instance->registerListener('main', 'author_logout', 'logout', '_csrf_token', NULL);
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_ROOT' => array(0 => 'ROLE_ADMIN', 1 => 'ROLE_ALLOWED_TO_SWITCH')));
    }
    ...
    {
        $this->services['security.user.provider.concrete.admin_provider'] = $instance = new \Symfony\Component\Security\Core\User\InMemoryUserProvider();

        $instance->createUser(new \Symfony\Component\Security\Core\User\User('god', '777', array(0 => 'ROLE_ROOT')));
    ...
    /**
     * Gets the 'security.user.provider.concrete.author_provider' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getSecurity_User_Provider_Concrete_AuthorProviderService()
    {
        return $this->services['security.user.provider.concrete.author_provider'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'AppBundle:Author', 'email', NULL);
    }
    ...
    protected function getStofDoctrineExtensions_Listener_UploadableService()
    {
        ...
        $instance->setDefaultPath(($this->targetDirs[3].'\\app/../web/images/post'));
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'stof_doctrine_extensions.default_file_path': $value = ($this->targetDirs[3].'\\app/../web/images/post'); break;
